...
//
  ...
  apps1.Start (Seconds (clientStart));
  apps1.Stop (Seconds (clientStop));
  ...
  apps2.Start (Seconds (clientStart));
  apps2.Stop (Seconds (clientStop));
  ...
  apps3.Start (Seconds (clientStart));
  apps3.Stop (Seconds (clientStop));
  ...
  apps4.Start (Seconds (clientStart));
  apps4.Stop (Seconds (clientStop));
